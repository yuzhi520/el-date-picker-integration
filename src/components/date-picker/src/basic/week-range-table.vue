<template>
  ...
  <table cellspacing="0" cellpadding="0" class="el-date-table is-week-mode" @click="handleClick"
  ...
  <tbody>
    ...
    <tr class="el-date-table__row" v-for="(row, key) in rows"
      :class="{ current: isWeekActive(row) }" :key="key">
...
<script>
  import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, prevDate, nextDate, isDate, clearTime as _clearTime} from '../../untils/date-util';
  import Locale from '../../mixins/locale';
  import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } from '../../untils/util';
